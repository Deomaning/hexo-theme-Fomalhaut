...
cover: https://s2.loli.net/2024/10/08/5WRhPqOe4Gma3ux.webp
---
...
|   |   |
|---|---|
|1  <br>2  <br>3  <br>4  <br>5  <br>6|<div class="gallery-group-main">  <br>  <br>{% galleryGroup '封面专区' '本站用作文章封面的图片，不保证分辨率' '/box/Gallery/photo' https://source.fomal.cc/img/default_cover_61.webp %}  <br>  <br>{% galleryGroup '背景专区' '收藏的一些的背景与壁纸，分辨率很高' '/box/Gallery/wallpaper' https://source.fomal.cc/img/dm11.webp %}  <br></div>|
